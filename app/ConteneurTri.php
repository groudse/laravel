...
class ConteneurTri extends Model
{
    ...
    public function getLastLevee($idConteneur){
        ...
        $last = DB::select("SELECT * from historique_conteneur_tris WHERE 
        point_de_collecte_id='".$idConteneur."'ORDER BY date DESC LIMIT 1; ");
    ...
    {
        $var = ConteneurTriPointDeCollecte::all()->first();
